 ...
 */
final class Version20260309101526 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE emprunt ADD CONSTRAINT FK_364071D7781F7189 FOREIGN KEY (stock_livre_id) REFERENCES stock_livre (id)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE emprunt DROP FOREIGN KEY FK_364071D7781F7189');
