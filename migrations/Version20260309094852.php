 ...
 */
final class Version20260309094852 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE stock_livre (id INT AUTO_INCREMENT NOT NULL, livre VARCHAR(255) NOT NULL, stock INT NOT NULL, PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4');
